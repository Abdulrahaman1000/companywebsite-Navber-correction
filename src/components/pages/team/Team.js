...
const Team = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 className=" text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Team</h2>
      </div> 
      <div className="grid gap-8 lg: md:grid-cols-2">
          <div className="items-center bg-gray-700 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
              ...
              <div className="p-5">
                  ...
                  <span className="text-white dark:text-gray-400">CEO & Web Developer</span>
                  <p className="mt-3 mb-4 font-light text-white dark:text-gray-400">Bonnie drives the technical strategy of the flowbite platform and brand.</p>
